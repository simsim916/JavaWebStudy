...
//		String password = request.getParameter("password");
	...
	throws IOException{
		...
		if ( realPath.contains(".eclipse."))// 개발중
			...
			else realPath ="Z:\\IDESet\\apache-tomcat-9.0.85\\webapps\\spring02\\resources\\uploadImages\\";
		...
		if (!file.exists()) {
	      ...
	      file = file = new File("Z:\\IDESet\\apache-tomcat-9.0.85\\webapps\\spring02\\"+realPath+"basicman1.jpg"); // uploadImages 폴더에 화일존재 확인을 위함
	...
	public String update (HttpSession session, HttpServletRequest request, Model model, MemberDTO dto) 
			throws IOException {
		String uri = "member/detail";
